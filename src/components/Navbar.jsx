...
export default function Navbar() {
  ...
  const privateLinks = user
    ? [
        { name: "My Products", href: "/myProducts" }, // All Products 
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white shadow-md">
      <div className="max-w-6xl mx-auto flex justify-between items-center p-4">
        {/* Logo */}
        <h2 className="text-2xl font-bold text-pink-600 md:text-3xl lg:text-4xl">
         <spen className="text-green-500">BD</spen><spen className="text-pink-600">Shop</spen>
        </h2>
              ...
              <Link
                ...
                className={`px-3 py-2 rounded-md font-medium ${
                  pathname === link.href
                    ...
                    : "text-green-500 hover:text-pink-800"
                }`}
              >
                {link.name}
              </Link>
        ...
        <div className="hidden md:flex items-center gap-4">
          {user ? (
            ...
            <>
              ...
              <Link
                href="/register"
                className="px-4 py-2 border border-pink-600 text-pink-600 rounded hover:bg-pink-100"
              >
                Register
              </Link>
            </>
