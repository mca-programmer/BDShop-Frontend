...
export default function Banner() {
  return (
    <div className="max-w-6xl mx-auto my-10 px-4">
      ...
      >
        {/* Slide 1 - Add Product */}
        <div className="relative h-80 md:h-96 bg-gradient-to-r from-pink-500 to-yellow-400 flex flex-col justify-center items-start p-6 md:p-12">
          ...
          <Link href="/addProduct">
            <button className="bg-white text-pink-600 font-semibold px-6 py-2 rounded hover:bg-gray-100 transition">
              Add Product
            </button>
          </Link>
        </div>
        ...
        {/* Slide 3 - Contact */}
        <div className="relative h-80 md:h-96 bg-gradient-to-r from-green-500 to-amber-400 flex flex-col justify-center items-start p-6 md:p-12">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">
            Contact Us
          </h2>
          <p className="text-white text-lg md:text-2xl mb-6">
